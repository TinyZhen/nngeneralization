...
seeds = [179665917]
        #  , 72060708, 670003938]
# seeds = [2807637955, 3077911943, 1648272741]
# seeds = [1341466118, 2294922852, 3852176231]
# seeds = [1572303298, 2822222643, 3629327305]
# seeds = [1605022043, 1007988374, 1478535812]
train_model = True
precomp = True
postcomp = True
...
# i = seeds
  ...
  if train_model:
    train_model_cmd = "export CUDA_VISIBLE_DEVICES=%d && python -m scripts.train_models2 --data " \
                      "cifar10 --model mlp --model_args 512 512  --seed %d --lr 0.0001 --epochs 100 --gpu %d " \
                      "--cuda --batch_size 64 --workers 8 %s --mode 1 --seed %d"
    ...
    #                   "cifar10 --model mlp --model_args 4096 4096 --seed %d --lr 0.0001 --epochs 100 --gpu %d " \
